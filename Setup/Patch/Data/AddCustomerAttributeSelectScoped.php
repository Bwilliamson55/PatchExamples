...
class AddCustomerAttributeSelectScoped implements DataPatchInterface
{
    ...
    private const ATTRIBUTE_DATA = [
        ...
        //Instead of the normal 'values' key, use 'value' and break down the values into option arrays
        'option' => [ 'value' =>
            [
                'option1'=>[
